...
public class GroupBarControl {
	...
	@ApiImplicitParams({
			@ApiImplicitParam(name = "refUserWxUnionid", value = "店铺所属用户", required = true, dataType = "string"),
			@ApiImplicitParam(name = "groubName", value = "店铺名称，店铺图片(多张图片，逗号分隔)", required = true, dataType = "string"),
			@ApiImplicitParam(name = "groubImg", value = "店铺图片(多张图片，逗号分隔)", required = true, dataType = "string"),
			@ApiImplicitParam(name = "groubPhone", value = "店铺客服电话", required = true, dataType = "string"),
			@ApiImplicitParam(name = "groubAddress", value = "店铺地址", required = true, dataType = "string") })
	@PostMapping("add")
	...
	@ApiImplicitParams({
			@ApiImplicitParam(name = "refUserWxUnionid", value = "店铺所属用户", required = true, dataType = "string"),
			@ApiImplicitParam(name = "groubName", value = "以下参数中，用户没改的，不要传或者传null对象，EX:{'groubAddress':NULL}", required = true, dataType = "string"),
