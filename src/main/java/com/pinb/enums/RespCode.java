...
public enum RespCode {
	 ...
	 * "30010", "活动开团火爆，已超限"
	 */
	order_openGrouba("30010", "活动火爆,开团数已超限"),
	/**
	 * "30011", "活动火爆,此团已满,您可以自己开团哦"
	 */
	order_groubaFull("30011", "活动火爆,此团已满,您可以自己开团哦"),
	/**
	 * "30009", "未找到团订单"
	 */
	order_unExistOrderTrace("30012", "未找到团订单"),
	/**
	 * "30011", "消费失败，消费订单不属于该拼吧"
	 */
	order_groubError("30014", "消费失败，消费订单不属于该拼吧"),
